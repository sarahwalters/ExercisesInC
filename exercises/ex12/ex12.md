...
counter_mutex used 12.960s + 12.268s = 25.228s of CPU time (more than "real" because there are two threads)
...
counter used 4.468s + 0.156s = 4.624s of CPU time.

Synchronization imposes about 20 seconds of overhead -- the program takes over five times as long to run.
